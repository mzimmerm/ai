...
# Alternative for ROCM_TORCH_WHL is to specify nithgtly torch builds; they have WHL files for rocm6.0-cp310. Those seem to be automatically selected when we specify simply:
...
*** glxinfo | egrep -i 'device|memory'
    Device: AMD Radeon Graphics (radeonsi, raven, LLVM 17.0.6, DRM 3.57, 6.7.9-1-default) (0x15dd)
    Video memory: 1024MB
    Unified memory: no
Memory info (GL_ATI_meminfo):
    VBO free memory - total: 729 MB, largest block: 729 MB
    VBO free aux. memory - total: 7309 MB, largest block: 7309 MB
    Texture free memory - total: 729 MB, largest block: 729 MB
    Texture free aux. memory - total: 7309 MB, largest block: 7309 MB
    Renderbuffer free memory - total: 729 MB, largest block: 729 MB
    Renderbuffer free aux. memory - total: 7309 MB, largest block: 7309 MB
Memory info (GL_NVX_gpu_memory_info):
    Dedicated video memory: 1024 MB
    Total available memory: 8465 MB
    Currently available dedicated video memory: 729 MB
...
** Installing PyTorch using the wheel whl files from AMD for ROCm 6.0.2.
