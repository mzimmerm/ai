...
ROCM_VERSION_6060002=40502-1 #  
ROCM_VERSION_602=21.40.2
...
echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/rocm.gpg] https://repo.radeon.com/amdgpu/${ROCM_VERSION_602}/ubuntu ${UBUNTU_RELEASE} main" \
...
AMDGPU_ROCM_PACKAGE_URL=https://repo.radeon.com/amdgpu-install/${ROCM_VERSION_602}/ubuntu/${UBUNTU_RELEASE}/${AMDGPU_ROCM_PACKAGE_FILE}
wget ${AMDGPU_ROCM_PACKAGE_URL}

#wget https://repo.radeon.com/amdgpu-install/6.0.2/ubuntu/${UBUNTU_RELEASE}/amdgpu-install_6.0.60002-1_all.deb
#wget https://repo.radeon.com/amdgpu-install/5.7.3/ubuntu/${UBUNTU_RELEASE}/amdgpu-install_5.7.50703-1_all.deb
